...
void main() {
  ...
  //  Fractional HP/damage is not allowed, so minimization problem where I must do 109 damage before BBG does 100.
  //  Because minimum damage dealt is 1, should never need armor greater than 1 less than BBG damage (AKA 7).
  //  Could probably create an equation to plug in, but will start with checking all setup combos.
  var cheapest = 10000;
...
bool simFight(List<int> boss, List<int> player) {
  ...
  //   // Calc turn based hits from health...
  // }
  //  We can cheat and immeditely determine victory if player effective damage > boss effective damage because
  //  there is not fractional damage and min damage per turn is 1.
