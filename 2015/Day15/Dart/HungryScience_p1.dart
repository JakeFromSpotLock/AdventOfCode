...
int calcCookieScore(List<int> combo, List<List<int>> metrics) {
  var capacity = 0;
  var durability = 0;
  var flavor = 0;
  var texture = 0;
  ...
  // final capacity = (metrics[0][0] * combo[0]) + (metrics[1][0] * combo[1]) + (metrics[2][0] * combo[2]) + (metrics[3][0] * combo[3]);
  // final durability = (metrics[0][1] * combo[0]) + (metrics[1][1] * combo[1]) + (metrics[2][1] * combo[2]) + (metrics[3][1] * combo[3]);
